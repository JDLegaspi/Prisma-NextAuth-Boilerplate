...
const RegisterPage: React.FC = () => {
        ...
        try {
            ...
            if (success) {
                ...
                toast({
                    ...
                    description: "You have successfully created and logged into your account.",
                    status: "success",
                    duration: 5000,
                    isClosable: true,
                });
    ...
    return (
        <Box width="full" maxWidth="md" mx="auto" mt="10">
            ...
            <Heading pt={8} as='h2' size='md' textAlign="center">To get started, sign up with a new email and password</Heading>
            <Box pt={8}>
